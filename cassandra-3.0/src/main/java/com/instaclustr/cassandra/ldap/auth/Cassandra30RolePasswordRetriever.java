...
public class Cassandra30RolePasswordRetriever implements CassandraPasswordRetriever
{

    private static final Logger logger = LoggerFactory.getLogger(Cassandra30RolePasswordRetriever.class);
